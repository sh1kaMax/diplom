...
const char *format_name1[] = {
  "BGRAp", "ARGBp", "RGBAp",
  "BGRA", "ARGB", "RGBA", "ABGR",
  "RGB", "BGR", NULL
};

const char *format_to_string_ok(GdkMemoryFormat1 format)
{
  if (format < sizeof(format_name1) / sizeof(format_name1[0]))
    return format_name1[format];
  else
    return "ERROR";
}