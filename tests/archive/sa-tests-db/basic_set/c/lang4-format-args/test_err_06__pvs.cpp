...
void Err3_NotEnoughArguments(FILE *file, double x, double y, double z)
{
    std::string formatstr = "%f %f %f %f";
    std::string_view vf = formatstr;
    fprintf(file, vf.data(), x, y, z); // FLAW
}